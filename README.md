## 👋 Hey, I'm Jagath (He/Him)

I'm a curious mind diving deep into how the **tech world truly works** — from systems thinking to full-stack execution.

- 💻 Full Stack Developer | Passionate Coder
- 🧠 150+ LeetCode problems solved (and counting)
- 🚧 Currently building: **XYZ** (more details soon!)
- 🌐 Exploring everything from frontend frameworks to cloud deployment
- 🛠️ Constantly building, breaking, learning, and growing
...
<!--
**JagathVishwa/JagathVishwa** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
